...
export class ContactsEffects {
  ...
  // loadSpreadsheet$ = createEffect( () => this.actions$.pipe(
  //   ofType(loadSpreadSheet), /* When action is dispatched */
  //   startWith(loadSpreadSheet()),
  //   /* Hit the Contacts Index endpoint of our REST API */
  //   /* Dispatch LoadAllSuccess action to the central store with id list returned by the backend as id*/
  //   /* 'Contacts Reducers' will take care of the rest */
  //   switchMap(() => this.contactsService.getSpreadsheet().pipe(
  //     map(contacts => loadSpreadSheetSuccess({contacts}))
  //   )),
  // ));
